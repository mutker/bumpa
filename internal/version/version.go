...
// getChangesSinceTag collects commit messages between the specified tag and HEAD
func (b *Bumper) getChangesSinceTag(tag string) (string, error) {
	...
	for commit != nil && commit.Hash != tagHash {
...
// getAllChanges retrieves all commit messages in the repository
func (b *Bumper) getAllChanges() (string, error) {
	// Get all commits
	var commits []string
	head, err := b.repo.Head()
	if err != nil {
